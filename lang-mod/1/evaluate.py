...
path = '/nlp/data/romap/lstm-lang/participants/'


flags = tf.flags

# data
flags.DEFINE_string('data_dir',   path + 'data/',   'data directory. Should contain train.txt/valid.txt/test.txt with input data')
flags.DEFINE_string('train_dir',   path + 'cv/',     'training directory (models and summaries are saved there periodically)')
flags.DEFINE_string('load_model',   path + 'cv/epoch024_5.1917.model',    '(optional) filename of the model to load. Useful for re-starting training from a checkpoint')
